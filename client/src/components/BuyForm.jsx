...
import {getRealEstatesByParamsBuy} from "../api/requests";
            ...
            <AccordionFormWrapper>
                <Formik
                    ...
                    onSubmit={async (values, {setSubmitting}) => {
                        values['typeOfPurchase'] = typeOfPurchase;
                        console.log("values that sent tp sevrever:", values);
                        await getRealEstatesByParamsBuy(values).then(res => {
                            if (res.length !== 0) {
                    ...
                    <Form>
                        ...
                        <Accordion expanded={expanded === 'expander'} onChange={handleChange('expander')}>
                            ...
                            <AccordionDetails>
                                ...
                                <FormAdditionalSection className={'year-completion'}>
                                    <div className="form_additional-section-name">Год сдачи ЖК</div>
                                    <MyCheckbox name="year2022">
                                        2022
                                    </MyCheckbox>

                                    <MyCheckbox name="year2023">
                                        2023
                                    </MyCheckbox>

                                    <MyCheckbox name="yearNotMatter">
                                        Неважно
                                    </MyCheckbox>
                                </FormAdditionalSection>
